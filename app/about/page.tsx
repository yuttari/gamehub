...
export default function AboutPage() {
  return (
    <div>
      ...
      <h1 className="text-3xl font-black tracking-tight text-ink-900">About GameHub</h1>
      <p className="mt-4 leading-relaxed text-ink-500">
        GameHub is a free online gaming platform featuring a curated collection of open-source HTML5 games.
      ...
      <p className="mt-3 leading-relaxed text-ink-500">
        Business cooperation or copyright claims: hello@gamehub.example
      </p>
      </div>
    </div>
  );
